...
import static Steps.GenerateTokenSteps.token;
...
public class APISteps {
    ...
    public void a_request_is_prepared_for_creating_an_employee_via_json_payload() {
        request=given().header(APIConstants.Header_Content_type,APIConstants.Content_type_value).header(APIConstants.Header_Authorization, token).
                body(APIPayloadConstants.createEmployeePayload());
    }
}
